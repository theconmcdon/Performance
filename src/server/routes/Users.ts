...
router.put('/:username', async (req, res) => {
  ...
  try {
    await db.Users.editUserProfile(editObj.username, editObj.email, editObj.profileName, editObj.profileBio, editObj.profileLocation, editObj.profilePhoto, editObj.tag1, editObj.tag2, editObj.tag3, username);
