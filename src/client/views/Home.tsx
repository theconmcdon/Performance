...
const Home = () => {
  ...
  const [prePost, setPrePost] = useState<newUser>({
    ...
    password: '',
    profileType: '',
    profilePhoto: 'https://us.123rf.com/450wm/happyvector071/happyvector0711904/happyvector071190414608/120957993-creative-illustration-of-default-avatar-profile-placeholder-isolated-on-background-art-design-grey-p.jpg?ver=6',
    profileName: '',
    profileBio: 'Set your bio!'
  })
