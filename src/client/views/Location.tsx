...
const Location = () => {
    ...
    return (
        <div className='custom'>
            ...
            <div style={{ margin: "auto" }} id='smallScreen' className='row bg-black border border-white invisible'>
                <div className='col-12 text-white'>{sidebarSelection}{colon}</div>
                <div className='col-12 text-white'>{length} {post}</div>
                
            </div>
            <div style={{ margin: "auto" }} className='row  pt-2 pb-5'>
                <div className='d-none d-sm-block col-lg-2 col-md-3 updateCard border-end'>
