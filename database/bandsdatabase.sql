...
('thebluebird', "4@test.com", 'password4', 'venue', 'The Bluebird', 'it me', 'Birmingham', 'https://mk0uncovercolor8845v.kinstacdn.com/wp-content/uploads/2020/02/denver-concert-venues-bluebird-theatre-1600x800-1.jpg', 10, 'Historic', 'Theater', 'Balconies'),
('kyleshucks', "5@test.com",  'password5', 'artist', 'Kyle Schucks','it me', 'Birmingham', 'https://www.indiewire.com/wp-content/uploads/2015/11/ape.jpg?w=640', 20, 'Stand Up', 'Cynical', 'Dark'),
('BnAWarehouse',"6@test.com", 'password6', 'venue', 'B&A Warehouse','it me', 'Birmingham', 'https://images-ext-2.discordapp.net/external/rMiOHlwaazm-okVPsJ_ypB-u0IUhKpx6eYMFf1MZygY/https/www.bawarehouse.com/wp-content/themes/bawarehouse/style/images/bkgd-grid-venues.jpg', 30, 'Weddings', 'Parties', 'Rentable'),
('AvondaleBrewery', "7@test.com", 'password4', 'venue', 'Avondale Brewery', 'Birmingham based brewery with the largest outdoor venue in town.', 'Birmingham', 'https://d2ftwog2ykfqwt.cloudfront.net/54e3e889688341b2a3b09353215aa494.jpg', 10, 'Brewery', 'Outdoor', 'Big Stage'),
('BlueManGroup', "8@test.com",  'password5', 'artist', 'Blue Man Group','Music and comedy collide in a visually engaging and unique format known world wide.', 'Birmingham', 'https://images-ext-2.discordapp.net/external/Y8sTFpgNP1bF6bEqwhd05GNVMhGEaRqaqktgO5TGm2k/https/attpac-website-assets.s3.amazonaws.com/assets/Image/6716-fitandcrop-660x365.jpg', 20, 'Performance', 'Comedy', 'Music'),
('nickshouse',"9@test.com", 'password6', 'venue', 'My House','it me', 'Birmingham', 'https://dynamicmoversnyc.com/wp-content/uploads/2018/11/house.jpg', 30, 'House Show', 'DJs', 'Indie'),
('littlecity', "10@test.com", 'password4', 'artist', 'Little City', 'Indie/bluegrass crustpunks from Dothan, Alabama.', 'Birmingham', 'https://liveon35mm.files.wordpress.com/2010/12/beachhouse12.jpg?w=584', 10, 'Indie/Bluegrass', 'Underground', 'Crustpunk'),
('CactusJack', "11@test.com",  'password5', 'artist', 'Travis Scott','Booking: kate@astroworldtour.com\n test', 'Birmingham', 'https://images-ext-1.discordapp.net/external/3bSjVYpL2Yas8UddKVm3hCr7hCUPgPi8AravKZiwpJU/%3Fresize%3D1800%2C1200%26w%3D1200/https/www.rollingstone.com/wp-content/uploads/2018/06/r1297_fea_travis-scott-opener-0326a443-8560-498c-be3e-98cb1002dec0.jpg?width=995&height=663', 20, 'Rapper', 'Hip Hop', 'Trap'),
...
('5', "is it me", 'pls ignore 2', 'NashvilleTennessee', 'Thu Aug 19 2021', '8pm', 'July 13th 2021', '9am', '75'),
...
('8', "Large Outdoor Bookings Available: Avondale Brewery", 'Bar crowd with the largest outdoor venue shared by small and large artists alike in the city of Birmingham. Booking and contact info in profile!', 'BirminghamAlabama', 'Tue Aug 31 2021', '7:00 PM', 'July 15th 2021', '3pm', '100'),
('6', "test post", 'pls ignore', 'BirminghamAlabama', 'Sat Aug 07 2021', '7pm', 'July 10th 2021', '10am', '125'),
...
('9', "Blue Man Group Comes Alive", 'Large venues preferred. All ages, no alcohol sales allowed.', 'BirminghamAlabama', 'Tue Aug 31 2021', '5pm', 'July 15th 2021', '3:00 PM', '50'),
('10', "test post", 'pls ignore', 'BirminghamAlabama', 'Sun Sep 19 2021', '7pm', 'July 10th 2021', '10am', '125'),
('11', "New in Town Tour", 'Small/medium venues preferred, house shows for premium. Contact info for booking on profile.', 'BirminghamAlabama', 'Sun Aug 22 2021', '8pm', 'July 13th 2021', '8:00 PM', '35'),
('12', "Wish You Were Here Tour", 'Large venues only. Booking: kate@astroworldtour.com', 'BirminghamAlabama', 'Sun Aug 22 2021', '5pm', 'July 15th 2021', '9:00 PM', '250k');
